...
public class RobotContainer {
    ...
    private final Command m_tarmacAuton = new AutonDriveCommand(m_driveSubsystem, 0,
            Constants.AutonConstants.kautonSpeedBackwards)
    ...
    private void configureButtonBindings() {
        ...
        m_IntakeButton.whenHeld(new IntakeCommand(m_intakeSubsystem, m_indexerSubsystem).alongWith(
                new SequentialCommandGroup(new TopIndexerIntakeCommand(m_indexerSubsystem),
