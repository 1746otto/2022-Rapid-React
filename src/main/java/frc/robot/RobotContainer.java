...
public class RobotContainer {
        ...
        private void configureButtonBindings() {
                ...
                xBoxLBumper.whenHeld(m_shooterFullPower
                                ...
                                .andThen(new IndexerUpperCommand(m_indexerSubsystem)
                                                ...
                                                .raceWith(new ShooterFullPowerCommand(
                                                                m_shooterSubsystem))
                                                .andThen(new IndexerFullForwardCommand(
                                                                m_indexerSubsystem).raceWith(
                                                                                new ShooterFullPowerCommand(
                                                                                                m_shooterSubsystem)))));
