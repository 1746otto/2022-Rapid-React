...
public class RobotContainer {
        ...
        private void configureButtonBindings() {
                ...
                JoystickButton m_driverStartButton = new JoystickButton(m_controller,
                                XboxController.Button.kStart.value);
                m_driverStartButton.whenHeld(m_visionTuningCommand);
                JoystickButton m_driverLBumper = new JoystickButton(m_controller,
                ...
                JoystickButton m_driverRBumper = new JoystickButton(m_controller,
                ...
                m_driverXButton.whenHeld(new IntakeCommand(m_intakeSubsystem, m_indexerSubsystem)
                                .alongWith(new SequentialCommandGroup(
                                                new TopIndexerIntakeCommand(m_indexerSubsystem),
                                                new BottomIndexerIntakeCommand(
                                                                m_indexerSubsystem))));
        }
