...
public class FullOuttakeCommand extends CommandBase {

  IndexerSubsystem m_indexerSubsystem;
  IntakeSubsystem m_intakeSubsystem;

  public FullOuttakeCommand(IndexerSubsystem indexer, IntakeSubsystem intake) {
  ...
  public void initialize() {
    m_indexerSubsystem.runBothFullBackward();
